 ...
 * 
 * * identifies a UserialUSB adapter
 ...
 *      create a worker thread and a pipe for a new seriel port, then open the port using the SerialID and VendorID of a USBserial Interface
...
unsigned char pipebuffer[NUM_OF_PIPES][BUFFER_LENGTH];
